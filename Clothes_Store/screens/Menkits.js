...
export default Menkits = ({route, navigation}) => {
        ...
        <View style={{marginBottom: 100, backgroundColor: '#fff'}}>
            <View style={styles.header}>
                ...
                <View style={styles.bodyHead}>
                    <View>
                        <Text style={{fontSize: 24}}>Men's</Text>
            ...
            <ScrollView style={{marginTop: 10}} showsHorizontalScrollIndicator={false}>
                <View style={styles.trendBody}>
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', marginTop: 20}}>
                        <Pressable onPress={()=> {navi.navigate('Product_Description', ['men', 15])}}>
                        ...
                        <Pressable onPress={()=> {navi.navigate('Product_Description', ['men', 16])}}>
                            <Image style={styles.trendImg} source={require('../assets/img/menSoccer2.jpg')}></Image>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', marginTop: 20}}>
                        <Pressable onPress={()=> {navi.navigate('Product_Description', ['men', 17])}}>
                            <Image style={styles.trendImg} source={require('../assets/img/menSoccer3.jpg')}></Image>
                            <Text>Man City 2023/24</Text>
                            <Text>Stadium Home</Text>
                            <Text style={styles.priceText}>$67.86</Text>
                        </Pressable>
                        <Pressable onPress={()=> {navi.navigate('Product_Description', ['men', 18])}}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', marginTop: 20}}>
                        <Pressable onPress={()=> {navi.navigate('Product_Description', ['men', 19])}}>
                            <Image style={styles.trendImg} source={require('../assets/img/menSoccer5.jpg')}></Image>
                            <Text>Netherland 2023/24</Text>
                            <Text>Stadium Home</Text>
                            <Text style={styles.priceText}>$70.99</Text>
                        </Pressable>
                        <Pressable onPress={()=> {navi.navigate('Product_Description', ['men', 20])}}>
                            <Image style={styles.trendImg} source={require('../assets/img/menSoccer6.jpg')}></Image>
                            <Text>Chelsea 2023/24</Text>
                            <Text>Stadium Home</Text>
                            <Text style={styles.priceText}>$69.86</Text>
                        </Pressable>
                    </View>
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', marginTop: 20}}>
                        <Pressable onPress={()=> {navi.navigate('Product_Description', ['men', 21])}}>
                            <Image style={styles.trendImg} source={require('../assets/img/menSoccer7.jpg')}></Image>
                            <Text>Germany 2023/24</Text>
                            <Text>Stadium Home</Text>
                            <Text style={styles.priceText}>$70.99</Text>
                        </Pressable>
                        <Pressable onPress={()=> {navi.navigate('Product_Description', ['men', 22])}}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', marginTop: 20}}>
                        <Pressable onPress={()=> {navi.navigate('Product_Description', ['men', 23])}}>
                            <Image style={styles.trendImg} source={require('../assets/img/menSoccer9.jpg')}></Image>
                            <Text>Argentina 2023/24</Text>
                            <Text>Stadium Home</Text>
                            <Text style={styles.priceText}>$70.99</Text>
                        </Pressable>
                        <Pressable onPress={()=> {navi.navigate('Product_Description', ['men', 24])}}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', marginTop: 20}}>
                        <Pressable onPress={()=> {navi.navigate('Product_Description', ['men', 25])}}>
                            <Image style={styles.trendImg} source={require('../assets/img/menSoccer11.jpg')}></Image>
                            <Text>Spain 2023/24</Text>
                            <Text>Stadium Home</Text>
                            <Text style={styles.priceText}>$70.99</Text>
                        </Pressable>
                        <Pressable onPress={()=> {navi.navigate('Product_Description', ['men', 26])}}>
                    ...
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', marginTop: 20}}>
                        <Pressable onPress={()=> {navi.navigate('Product_Description', ['men', 27])}}>
                            <Image style={styles.trendImg} source={require('../assets/img/vietnam.jpg')}></Image>
                            <Text>Vietnam 2023/24</Text>
                            <Text>Stadium Away</Text>
                            <Text style={styles.priceText}>$70.99</Text>
                        </Pressable>
                        <Pressable onPress={()=> {navi.navigate('Product_Description', ['men', 28])}}>
